...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '361a6bf8-0017-47a8-a53f-8d7fe46ae6b3' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b74ac71f-a885-43bf-ad2c-ddabcf2dac94');
      cy.get(`[data-cy="name"]`).should('have.value', 'b74ac71f-a885-43bf-ad2c-ddabcf2dac94');
