...
export class AuditService {
    ...
    getAuditsPagination(params?: Record<string, any>): Observable<ApiResponse<PaginationResponse<AuditLog>>> {
        return this.http.get<ApiResponse<PaginationResponse<AuditLog>>>(this.api, { params });
    }
